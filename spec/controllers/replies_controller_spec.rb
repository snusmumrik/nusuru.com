  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reply as @reply" do
        ...
        post :create, {:reply => { "user" => "invalid value" }}, valid_session
        assigns(:reply).should be_a_new(Reply)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reply" do
        ...
        Reply.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => reply.to_param, :reply => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reply as @reply" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reply.any_instance.stub(:save).and_return(false)
        put :update, {:id => reply.to_param, :reply => { "user" => "invalid value" }}, valid_session
        assigns(:reply).should eq(reply)
      end
